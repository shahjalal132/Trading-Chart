        ...
        <div className="min-h-screen p-8 text-white">
            <div className="mx-auto max-w-6xl">
                ...
                <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    {/* Course Info Card */}
                    <div className="rounded-lg bg-[#222428] p-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="rounded-full bg-[#222428] px-6 py-2 text-sm font-medium transition-colors hover:bg-gray-700">
                            Curriculum
                        </button>
                        <button className="rounded-full bg-[#222428] px-6 py-2 text-sm font-medium transition-colors hover:bg-gray-700">
                            Instructor
                ...
                <div className="rounded-lg bg-[#222428] p-8">
                    ...
                    {/* Review Carousel */}
                    <div className="relative rounded-lg bg-[#222428] p-8">
